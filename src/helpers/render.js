    ...
    return (
      <>
        <article>
          <p>
            {i18next.t(
              '提示：${{price}} * {{ratio}} = ${{total}} / 1M tokens',
              {
          ...
          <p>
            {i18next.t(
              '补全：${{price}} * {{ratio}} = ${{total}} / 1M tokens',
              {
    ...
    return (
      <>
        <article>
          ...
          <p>
            {i18next.t(
              '音频提示：${{price}} * {{ratio}} * {{audioRatio}} = ${{total}} / 1M tokens',
              {
                price: inputRatioPrice,
                ratio: groupRatio,
                audioRatio,
          ...
          <p>
            {i18next.t(
              '音频补全：${{price}} * {{ratio}} * {{audioRatio}} * {{audioCompRatio}} = ${{total}} / 1M tokens',
              {
                price: inputRatioPrice,
                ratio: groupRatio,
                audioRatio,
          ...
          <p>
            {i18next.t(
              '音频提示 {{input}} tokens / 1M tokens * ${{price}} * {{audioRatio}} + 音频补全 {{completion}} tokens / 1M tokens * ${{price}} * {{audioRatio}} * {{audioCompRatio}}',
              {
